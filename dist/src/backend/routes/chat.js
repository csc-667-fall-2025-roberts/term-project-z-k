...
router.get('/rooms/:roomId/messages', async (req, res) => {
    try {
        ...
        const result = await database_1.db.query(`SELECT cm.id, cm.message, cm.sent_at, cm.user_id, u.username
...
router.post('/rooms/:roomId/messages', async (req, res) => {
    try {
        ...
        const result = await database_1.db.query(`INSERT INTO chat_messages (room_id, user_id, message) VALUES ($1, $2, $3) RETURNING id, sent_at`, [roomId, userId, message]);
